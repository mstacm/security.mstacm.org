...
function generateOfficers(){
    ...
    d3.csv("../miscContent/officers.csv").then(function(data){
        ...
        for (var i = 0; i < yearEntries.length; i++){
            ...
            // Row div
            tabBlock += '<div class="row justify-content-md-center">';
            ...
            for(var j = 0; j < yearEntries[i].officerEntries.length; j++) {
                ...
                if (yearEntries[i].officerEntries[j].image == "N/A") {
                    tabBlock += '<img class="img-fluid" src="../images/officers/blank.png" alt="' +
